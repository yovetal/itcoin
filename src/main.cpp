...
uint256 hashGenesisBlock("0xd596669d22839479b6be9794c005aa79e23e3dbd76d2d226267efb74f9c9daaf");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ItCoin: 1 days
static const int64 nTargetSpacing = 600; // ItCoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal itcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ItCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xad7567fe61a52250a674719a82b3e71dba5d7992a70da2355206cd2df2f601f9");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Last friday of summer 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1503691824; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 551282;

        if (fTestNet)
        {
            block.nTime    = 1503690142;
            block.nNonce   = 193630;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf15a2e1a4430967b31c97e215f0f3401de098b331ae60a5e6abc8d92e1f24c16"));
